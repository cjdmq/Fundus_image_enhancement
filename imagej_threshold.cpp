...
AutoThresholder* AutoThresholder::Instance()
{
    static AutoThresholder* instance = nullptr;
    if (nullptr == instance) {
        instance = new AutoThresholder();
    }
    return instance;
}
...
/*****************************************常用函数*********************************************/
int AutoThresholder::CalcMaxValue(int a, int b)
{
    return (a > b) ? a : b;
}

double AutoThresholder::CalcMaxValue(double a, double b)
{
    return (a > b) ? a : b;
}

int AutoThresholder::CalcMinValue(int a, int b)
{
    return (a < b) ? a : b;
}

double AutoThresholder::CalcMinValue(double a, double b)
{
    return (a < b) ? a : b;
}
...
bool AutoThresholder::BimodalTest(std::vector<double>& y)
{
    int len = y.size();
    bool b = false;
    int modes = 0;
...
/***************************************MinErrorI***************************************************/
double AutoThresholder::A(const std::vector<int>& y, int j)
{
...
double AutoThresholder::B(const std::vector<int>& y, int j)
{
    if (j >= y.size()) j = y.size() - 1;
    double x = 0;
    for (int i = 0; i <= j; i++)
...
double AutoThresholder::C(const std::vector<int>& y, int j)
{
    if (j >= y.size()) j = y.size() - 1;
    double x = 0;
    for (int i = 0; i <= j; i++)
...
double AutoThresholder::PartialSum(const std::vector<int>& y, int j)
{
    double x = 0;
    for (int i = 0; i <= j; i++)
        x += y[i];
